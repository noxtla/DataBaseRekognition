...
('On Leave'),          -- En algún tipo de permiso (general)
('Sick Leave'),        -- Baja por enfermedad
('Maternity Leave'),   -- Licencia por maternidad
('Paternity Leave'),   -- Licencia por paternidad
('Vacation'),          -- En vacaciones
('Suspended'),         -- Suspendido temporalmente
('Terminated'),        -- Ya no forma parte de la empresa
('Training');          -- En capacitación o entrenamiento
...
-- Solo si ya asignaste status a todos los empleados
ALTER TABLE employees
...
-- Ejemplo: Asignar a todos el estado "Active" (status_id = 1)
UPDATE employees
SET status_id = 7;
